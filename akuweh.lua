...
titleLbl=Create("TextLabel",topbar,{Name="titleLbl", TextWrapped=true, Size=UDim2.new(0.5,0,1,0), Text="Pizza irwan v4", TextSize=14, Font="GothamSemibold", 
...
creditLbl=Create("TextLabel",main,{Position=UDim2.new(0,0,1,5),Size=UDim2.new(0.6, 0, 0, 18),BackgroundTransparency=1,TextColor3=Color3.new(1,1,1),Text="by Massimo",TextScaled=true,TextStrokeTransparency=.8})
